...
""" Kiír minden adatot adott mappában további feldolgozásra NUMPY tömbökbe pickle használatával"""
import numpy as np
import os
...
for inst in instances:
    if inst.endswith('.bin'):
        ...
        for angle in rot_angles:
            ...
            with open('rotation/'+label+'/'+str(cnt)+'.pkl', "wb") as f:
